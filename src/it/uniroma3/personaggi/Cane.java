...
public class Cane extends AbstractPersonaggio{
	...
	private static final String MESSAGGIO_MORSO_SALUTO = "Woof woof! >:( \n(Non osare salutarmi! "
			+ "Ti ho morso e ti ho levato un CFU >:( )";
	...
	private static final String MESSAGGIO_MORSO_REGALO_GIUSTO = "Slurp! Woof woof!!! :) \n(Grazie, non mangiavo da una molto tempo..."
			+ "Ecco a te un regalo per la tua gentilezza!";

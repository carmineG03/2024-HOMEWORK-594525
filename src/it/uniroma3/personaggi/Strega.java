...
public class Strega extends AbstractPersonaggio{
	...
	private static final String MESSAGGIO_NON_SALUTATO = "NEANCHE MI SALUTI E VUOI AIUTO DA ME? IMPARA IL RISPETTO UMANO ORA SPARISCI!";

	private static final String MESSAGGIO_SALUTATO = "Che persona gentile, va bene, ti aiuterò! Andrai in una stanza piena di"
			+ "tesori, guarda bene!";
	
	private static final String MESSAGGIO_REGALO = "AHAHAHAHAHAHAHAH";
